	...
	<form method="post">
		...
		<table class="tableForm">
			<tr>
				...
				<th>排序</th>
				<td><input name="cseq" class="easyui-numberspinner" data-options="min:0,max:999,editable:false,required:true,missingMessage:'请选择部门排序'" value="10" style="width: 155px;" /></td>
			</tr>
			<tr>
				<th>部门信息</th>
