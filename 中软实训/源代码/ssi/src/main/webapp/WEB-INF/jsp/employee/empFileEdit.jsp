...
<form method="post" enctype="multipart/form-data">
	<table>
		<tr>
			<td>工号</td>
			<td><input id="id" name="id" class="easyui-textbox" style="width: 150px" readonly="readonly" data-options="required:true"></td>
			<td>档案号</td>
			<td><input id="tid" name="tid" class="easyui-textbox" style="width: 150px" readonly="readonly" data-options="required:true"></td>
		</tr>
		<tr>
			<td>身份证号</td>
			<td>
